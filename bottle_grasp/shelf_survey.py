...
(`BottleDemo._collect_fresh_depth_frames`, `T_base_head_camera`,
...
purpose (see `bottle_grasp/SAFETY_PROFILES.md`), and a script should not
...
def run_shelf_survey(
    ...
    *,
    ...
    `BottleDemo._collect_fresh_depth_frames` for the same multi-frame
