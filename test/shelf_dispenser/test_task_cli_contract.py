...
def cli(monkeypatch):
    ...
    monkeypatch.delitem(sys.modules, "scripts.run_pick_place_task", raising=False)
    return importlib.import_module("scripts.run_pick_place_task")
...
def test_main_writes_manifest_before_starting_the_task(cli, monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(cli, "RunOrchestrator", FakeDemo)
