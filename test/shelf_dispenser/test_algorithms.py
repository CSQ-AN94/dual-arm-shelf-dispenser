...
from shelf_dispenser.perception import depth_point_for_detection, robust_near_cluster
...
def test_safety_profile_rejects_invalid_grasp_height_fraction(tmp_path, value):
    source = Path(__file__).parents[2] / "shelf_dispenser" / "safety_profiles.json"
