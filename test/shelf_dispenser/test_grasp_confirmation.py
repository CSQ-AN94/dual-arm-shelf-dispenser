...
(run_task_resume.sh) the way the 2026-07-18 real-run session did.

The wait must not swallow Ctrl+C/STOP: run_pick_place_task.py's signal handler
...
from shelf_dispenser.core import Localization, SafetyAbort
